...
const HeroSection = () => {
  ...
  return (
    <div ref={heroRef}>
      <div className='p-4 md:flex items-center justify-between md:mt-20'>
        <div className='md:w-[60%] text-center flex items-center justify-center flex-col gap-3 text-white'>
          ...
          <p className='hero-text md:p-2 p-1 md:w-[80%]'>
          ...
          <div className='hero-buttons flex gap-4 md:mt-4 w-full justify-center'>
